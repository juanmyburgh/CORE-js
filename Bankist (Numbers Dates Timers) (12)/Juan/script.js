...
const account1 = {
  ...
  movementsDates: [
    ...
    '2025-01-02T23:36:17.929Z',
    '2025-01-07T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const startLogoutTimer = function () {
  const tick = function () {
    ...
    // In each call, update timer in UI
    labelTimer.textContent = `${min}:${sec}`;

    // When reaches 0, stop timer and Logout user
    if (time === 0) {
      clearInterval(timer);
...
console.log('-----Checking if integer-----');
...
const randomInt = (min, max) => console.log(Math.floor(Math.random() * (max - min + 1)) + min);
...
console.log(37658342658623856832465230652645926n);
console.log(BigInt(3765834265862385));

console.log(10000n + 10000n);
console.log(89768564286489235n * 10000000n);

const huge = 966123894645243581276348n;
const num = 23;
...
console.log(new Date('Dec 21 2024 15:52:52'));
...
console.log('AU: ', new Intl.NumberFormat('en-AU', options).format(num));
...
setInterval(function () {
  ...
  console.log(`The current time is ${String(hour).padStart(2, 0)}:${String(minute).padStart(2, 0)}:${String(second).padStart(2, 0)}`);
}, 1000);
*/
// -----------------------------------------------------------------------
